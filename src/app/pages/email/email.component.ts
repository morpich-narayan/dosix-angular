...
@Component({
  ...
  standalone: true,
  imports: [NgxEditorModule, NgbDropdownModule, SimplebarAngularModule, FormsModule, CommonModule, AccordionModule, RouterModule]
})
 ...
 */
  ...
  openComposeModal(content: TemplateRef<any>) {
