...
import { fetchtableData } from '../../store/CRM/crm.actions';
import { selectabledata } from '../../store/CRM/crm-selector';
import { selectData } from '../../store/chat/chat.selector';
import { fetchfeedbackdataData, fetchrentproprtydataData, fetchsalepropertydataData } from '../../store/RealEstate/realEstate.action';
import { selectfeedData, selectrentData, selectsaleData } from '../../store/RealEstate/realEstate-selector';
import { NgApexchartsModule } from "ng-apexcharts";
import { shuffleArray } from '../../../core/commonFunction';
...
@Component({
  ...
  standalone:true,
  imports:[CommonModule,NgApexchartsModule,BreadcrumbsComponent,CountUpModule,ProgressbarModule],
