...
@Component({
  ...
  standalone:true,
  imports:[CommonModule,FormsModule,BreadcrumbsComponent,PaginationModule,NgPipesModule,NgbdGridJsSortableHeader,CardTableComponent,TableSearchComponent,TableSortingComponent,TableLoadingComponent],
