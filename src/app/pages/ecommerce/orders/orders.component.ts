...
import { addOrderData, deleteOrderData, fetchOrderdata, updateOrderData } from '../../../store/Orders/order.action';
import { selectData } from '../../../store/Orders/order.selector';
...
@Component({
  ...
  standalone:true,
  imports:[BreadcrumbsComponent,NgApexchartsModule,CountUpModule,FormsModule,CommonModule,PaginationModule,ReactiveFormsModule,FlatpickrModule,NgbDropdownModule],
  providers:[FlatpickrDefaults,DecimalPipe,DatePipe]
})
