...
import { deleteinvoice, fetchInvoiceData, fetchInvoicelistData } from '../../../store/Invoices/invoices.action';
import { selectData, selectDataLoading, selectlistData } from '../../../store/Invoices/invoices.selector';
// import { selectData } from 'src/app/store/Invoices/invoices.selector';
...
@Component({
  ...
  standalone:true,
  imports:[BreadcrumbsComponent,CommonModule,CountUpModule,ProgressbarModule,FormsModule,PaginationModule]
})
