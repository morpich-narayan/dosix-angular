...
import { FlatpickrDirective, FlatpickrModule, FlatpickrDefaults } from 'angularx-flatpickr';
...
@Component({
  ...
  standalone: true,
  imports: [FullCalendarModule, ReactiveFormsModule, CommonModule, BsDatepickerModule, FlatpickrModule, SimplebarAngularModule, TimepickerModule],
...
export class CalendarComponent {
  ...
  constructor(private formBuilder: UntypedFormBuilder, public ts: TitleService, private templateRegistry: TemplateRegistryService) { }

  ngOnInit(): void {
    this.ts.setItem('Calender')
    // Validation
 ...
 */
  ...
  openModal(events?: any) {
    ...
    this.modalService.open(this.addNew)

    this.submitted = false;
    this.newEventDate = events;
  }

  openModalFromTemplate(content: TemplateRef<any>) {
